            ...
            <TabsContent value="basics" className="space-y-5 pt-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {COLOR_PALETTE.map((color) => (
                    <button
                      ...
                      title={color.label}
                      onClick={() => {
                        setValue('color_theme', color.hex, { shouldValidate: true })
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                  <div
                    className="w-8 h-8 rounded-md shadow-sm flex-shrink-0 transition-colors"
                ...
                {errors.color_theme && (
                  <p className="text-sm text-destructive">{errors.color_theme.message}</p>
                )}
              </div>
